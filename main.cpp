    ...
    for (int c= 0; c < NUM_CLASSES; c++)
    {
        ...
        {  const auto NUM_COLORS = sizeof(colors)/sizeof(colors[0]);
            ...
            if(rect.width/rect.height <2.5){
                ...
                //tach 2 dong
                //dong1
                Mat crop_plate = plate_cop(Rect(rect.x+60,rect.y+15,rect.width-120,(int)(rect.height/2)-8));
                ...
                //dong2
                Mat crop_dong2_1=plate_cop(Rect(rect.x+25,rect.y+(int)(rect.height/2),rect.width-35,(int)(rect.height/2)-2));
                ...
                Mat crop_1line=plate_cop(Rect(rect.x+30,rect.y,rect.width-30,rect.height));
